...
/** Report elements of the match table for the given pattern.  This
  ...
  * the Pattern object.
  *
  * @param pat pointer to the pattern for which we want to check reported matches.
  * @param begin index of the first character in the substring
  * @param end index one-past-the-end of the string
  * @return true if this pattern matches the [begin, end) substring of the most recent input string
  */
